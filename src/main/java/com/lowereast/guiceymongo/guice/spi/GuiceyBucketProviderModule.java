...
class GuiceyBucketProviderModule extends SingletonModule<Key<GuiceyBucket>> implements Provider<GuiceyBucket> {
	private final String _bucketKey;
	private Provider<GridFS> _gridFsProvider;

	public GuiceyBucketProviderModule(String bucketKey) {
	...
	public void configure(Binder binder) {
		binder.skipSources(GuiceyBucketProviderModule.class).bind(key).toProvider(this);
	}
